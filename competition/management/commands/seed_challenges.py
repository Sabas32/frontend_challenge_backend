...
""",
        ...
        extra_specs = [
            ...
            },
            {
                ...
                "description": "Design a leaderboard tile with rank, user, and points.",
                "difficulty": "easy",
                "time_limit": 12,
                "category": "list",
                "accent": "#facc15",
            },
            {
                ...
                "description": "Create a summary card with score, time, and status pill.",
                "difficulty": "easy",
                "time_limit": 14,
                "category": "card",
                "accent": "#34d399",
            ...
            {
                "title": "Admin Stat Strip",
                "description": "Design a horizontal strip of stats with icons and labels.",
                "difficulty": "easy",
                "time_limit": 12,
                "category": "dashboard",
                "accent": "#f472b6",
            ...
            {
                "title": "Compact Table Row",
                "description": "Create a table row with status, score, and action button.",
                "difficulty": "easy",
                "time_limit": 12,
                "category": "table",
                "accent": "#22c55e",
            },
            {
                ...
                "description": "Design an announcement card with title, date, and CTA.",
                "difficulty": "easy",
                "time_limit": 12,
                "category": "card",
                "accent": "#f59e0b",
            },
            {
                ...
                "description": "Build a table header row with columns and sorting icons.",
                "difficulty": "medium",
                "time_limit": 18,
                "category": "table",
                "accent": "#06b6d4",
            ...
            {
                "title": "Rank Podium",
                "description": "Create a podium layout showing top three competitors.",
                "difficulty": "hard",
                "time_limit": 28,
            ...
            {
                "title": "Score Badge Stack",
                "description": "Design stacked badges for score, attempts, and position.",
                "difficulty": "easy",
                "time_limit": 12,
                "category": "badge",
                "accent": "#f87171",
            },
            {
                ...
                "description": "Create a quick action bar with three action buttons.",
                "difficulty": "easy",
                "time_limit": 12,
                "category": "navigation",
                "accent": "#60a5fa",
            ...
            {
                "title": "Analytics Mini Chart",
                "description": "Build a mini chart card with summary stats.",
                "difficulty": "hard",
                "time_limit": 24,
                "category": "chart",
                "accent": "#34d399",
